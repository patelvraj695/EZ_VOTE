...
class multipleOption extends StatefulWidget {
  @override
  _multipleOption createState() => _multipleOption();
}

class _multipleOption extends State<multipleOption> {
...
/////////////////////////////////////////////////////////////////////////////////
  ...
  Future<void> addData()async{
    final _firestore=await(Firestore.instance.collection('Multiple Options').document());
